...
def main():
    ...
    parser.add_argument("--use_german_stopwords", action="store_true", default=True,
                        help="Enable German stopwords (default: enabled)")
    ...
    # German stopwords improve topic coherence for German content
    vectorizer_stop_words = GERMAN_STOPWORDS if args.use_german_stopwords else None
    print(f"Vectorizer stop_words: {'German' if args.use_german_stopwords else 'None'}")
